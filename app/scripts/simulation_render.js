var SIMR = (function () {
    ...
    var sprRedBall = createSprite(CDRAW.loadImage("images/ball_red.svg"));
    var sprBlueBall = createSprite(CDRAW.loadImage("images/ball_blue.svg"));
    var sprWhiteBall = createSprite(CDRAW.loadImage("images/ball_white.svg"));
    var sprPlayfield = createSprite(CDRAW.loadImage("images/playfield.svg"));
